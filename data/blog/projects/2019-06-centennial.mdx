...
date: '2019-06'
tags: ['projects', 'energy', 'monitoring', 'canada', 'tesla']
draft: false
summary: 캐나다 온타리오주 센테니얼 대학의 태양광-충전기 시스템 모니터링을 위한 웹 프로그램 개발
---
...
![toc1](/static/images/projects/toc1.png)

![toc2](/static/images/projects/toc2.png)
...
![map](/static/images/projects/map.png)
